...
<div id="main_contact">
  <div id="phylosophy_area" style="overflow-x:hidden; padding-top:1%;text-align:center">
    <img src="../../assets/images/success.png" style="height:50%;width:50%">  
    <h3>Το μήνυμα σας στάλθηκε με επιτυχία!</h3> 
    <h4>Σας ευχαριστούμε για το ενδιαφέρον,θα σας απαντήσουμε το συντομότερο δυνατόν!</h4> 
  </div>
</div>
